...
import 'package:simpletreasury/features/transactions/domain/usecases/delete_transactions_by_treasury.dart';
...
void main() {
  late DeleteTransactionsByTreasuryIdUseCase usecase;
  late MockTransactionsRepository mockRepository;

  setUp(() {
    mockRepository = MockTransactionsRepository();
    usecase = DeleteTransactionsByTreasuryIdUseCase(mockRepository);
  });

  test(
    'should call repository.deleteTransactionByTreasuryId and return Right(Unit) on success',
    () async {
      // arrange
      when(
