...
void main() {
  late SoftDeleteTransactionUsecase usecase;
  late MockTransactionsRepository mockRepository;

  setUp(() {
    mockRepository = MockTransactionsRepository();
    usecase = SoftDeleteTransactionUsecase(mockRepository);
  });

  test(
    'should call repository.softDeleteTransaction and return Right(Unit) on success',
    () async {
      // arrange
      when(
